...
OUTPUT_ROOT="analysis_density_joint"
...
python scripts/summarize_flow_eps_curves.py \
  --input-csv analysis/coverage_v2_flow_only_raw_joint_curves_full.csv \
  --output-csv "${OUTPUT_ROOT}/coverage_v2_flow_only_raw_joint_curve_summary.csv" \
  --coverage-thresholds 0.9,0.95

python scripts/summarize_flow_eps_curves.py \
  --input-csv analysis/coverage_v2_flow_only_raw_joint_kmeans_curves_full.csv \
  --output-csv "${OUTPUT_ROOT}/coverage_v2_flow_only_raw_joint_kmeans_curve_summary.csv" \
  --coverage-thresholds 0.9,0.95 \
  --weighted
...
python scripts/build_leakage_free_eval.py \
  ...
  --coverage-csv "${OUTPUT_ROOT}/coverage_v2_flow_only_raw_joint_curve_summary.csv" \
...
python scripts/build_leakage_free_eval.py \
  ...
  --coverage-csv analysis/coverage_v2_flow_only_raw_joint_kmeans_full.csv \
...
python scripts/build_leakage_free_eval.py \
  ...
  --coverage-csv analysis/coverage_v2_flow_only_raw_joint_kmeans_manifold_full.csv \
