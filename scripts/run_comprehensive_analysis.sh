...
PREDICTORS="flow_train_to_eval_over_eval_recall_logit,flow_eval_to_train_over_train_precision_logit,flow_train_to_eval_mean_dist_over_radius_eval,flow_train_to_eval_mean_dist_over_radius_train,flow_eval_to_train_mean_dist_over_radius_eval,flow_eval_to_train_mean_dist_over_radius_train,flow_eval_to_train_mean_dist,flow_train_to_eval_mean_dist,flow_eval_to_train_kl_div,flow_train_to_eval_kl_div,flow_eval_to_train_kl_div_hist,flow_train_to_eval_kl_div_hist,flow_eval_to_train_kl_div_hist_log1p_linear,flow_train_to_eval_kl_div_hist_log1p_linear,flow_mmd,dino_train_to_eval_over_eval_recall_logit,dino_eval_to_train_over_train_precision_logit,dino_train_to_eval_mean_dist_over_radius_eval,dino_train_to_eval_mean_dist_over_radius_train,dino_eval_to_train_mean_dist_over_radius_eval,dino_eval_to_train_mean_dist_over_radius_train,dino_eval_to_train_mean_dist,dino_train_to_eval_mean_dist,dino_eval_to_train_kl_div,dino_train_to_eval_kl_div,dino_eval_to_train_kl_div_hist,dino_train_to_eval_kl_div_hist,dino_eval_to_train_kl_div_hist_log1p_linear,dino_train_to_eval_kl_div_hist_log1p_linear,dino_mmd"
